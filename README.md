...
- Version 0.4.4 adds a multi-region map catalog and automatic scene switching.
...
- The player marker uses a larger, solid original-game-style arrow with a dark
  shadow and configurable color.
